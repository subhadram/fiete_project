...
for t = 3:length(timet)
    ...
    a0(t) = a0(t-1) + (I0/tau + a1(t-1)*dz/dt- sqrt(2)/(4*tau)*a2(t-1)- (1-lamb)/tau*a0(t-1))*dt;
    a1(t) = a1(t-1) + (I1/tau - (sqrt(sqrt(2*pi)*a)*U_0 + a0(t-1) - sqrt(2)*a2(t-1))/(2*a)*dz/dt)*dt;
